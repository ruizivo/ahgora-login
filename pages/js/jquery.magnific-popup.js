...
(function (a) {
  ...
  const j = '.' + i
  const k = 'mfp-ready'
  const l = 'mfp-removing'
  const m = 'mfp-prevent-close'
  let n
  const o = function () {}
  const p = !!window.jQuery
  let q
  const r = a(window)
  let s
  let t
  ...
  (o.prototype = {
    ...
    open: function (b) {
      ...
      const h = a.magnificPopup.modules
      ...
      u && n.wrap.addClass(u)
      const l = (n.wH = r.height())
      const m = {}
      if (n.fixedContentPos && n._hasScrollBar(l)) {
        const o = n._getScrollbarSize()
        o && (m.marginRight = o)
      }
      n.fixedContentPos &&
        (n.isIE7
    ...
    updateItemHTML: function () {
      ...
      (n.currItem = b)
      if (!n.currTemplate[c]) {
        const d = n.st[c] ? n.st[c].markup : !1
        y('FirstMarkupParse', d),
        d ? (n.currTemplate[c] = a(d)) : (n.currTemplate[c] = !0)
      }
      t && t !== b.type && n.container.removeClass('mfp-' + t + '-holder')
      const e = n['get' + c.charAt(0).toUpperCase() + c.slice(1)](
        b,
        n.currTemplate[c]
      )
      n.appendContent(e, c),
    ...
    _checkIfClose: function (b) {
      ...
      const c = n.st.closeOnContentClick
      const d = n.st.closeOnBgClick
      if (c && d) return !0
      if (
        !n.content ||
  ...
  (a.fn.magnificPopup = function (b) {
    ...
    if (typeof b === 'string') {
      if (b === 'open') {
        let d
        const e = p ? c.data('magnificPopup') : c[0].magnificPopup
        const f = parseInt(arguments[1], 10) || 0
        e.items
          ? (d = e.items[f])
    ...
    proto: {
      initZoom: function () {
        ...
        const g = function (b) {
          ...
          const d = 'all ' + a.duration / 1e3 + 's ' + a.easing
          const e = {
            position: 'fixed',
            zIndex: 9999,
            left: 0,
      ...
      _getOffset: function (b) {
        ...
        const d = c.offset()
        const e = parseInt(c.css('padding-top'), 10)
        const f = parseInt(c.css('padding-bottom'), 10)
  ...
  const R = function (a) {
    'use strict'
    if (n.currTemplate[P]) {
      const b = n.currTemplate[P].find('iframe')
      b.length &&
        (a || (b[0].src = Q),
  ...
  a.magnificPopup.registerModule('gallery', {
    ...
    proto: {
      initGallery: function () {
        ...
        w('BuildControls' + d, function () {
          ...
          if (n.items.length > 1 && c.arrows && !n.arrowLeft) {
            const b = c.arrowMarkup
            const d = (n.arrowLeft = a(
              b.replace(/%title%/gi, c.tPrev).replace(/%dir%/gi, 'left')
            ).addClass(m))
            const e = (n.arrowRight = a(
      ...
      preloadNearbyImages: function () {
        'use strict'
        const a = n.st.gallery.preload
        const b = Math.min(a[0], n.items.length)
        const c = Math.min(a[1], n.items.length)
        let d
